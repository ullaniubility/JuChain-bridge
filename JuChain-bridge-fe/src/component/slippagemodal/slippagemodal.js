...
export default function SlippageModal({ setShowSlippageModal }) {
  return (
    <React.Fragment>
      {/* Slippage Modal Starts Here */}
        ...
        >
          <div className="relative w-[95%] mx-auto h-full">
            ...
            <div className="max-[768px]:w-[95%] mt-11 relative mx-auto border-0 rounded-2xl shadow-2xl flex flex-col w-[450px] bg-black outline-none focus:outline-none">
              {/*header*/}
              <button className='close-modal absolute right-[20px] top-[12px]' onClick={() => setShowSlippageModal(false)}>
                <svg
              ...
              <div className='modal-content rounded-2xl bg-black px-[20px] py-3 mt-4'>
                <div className='mt-4 mb-6'>
                  ...
                  <p className='text-sm text-center text-white my-6'>
                    CYour transaction will revert if the price change unfavorably by more than this percentage.
                  </p>
                  <div className='grid grid-cols-3 rounded-full bg-[#00513a]'>
                    <button className='bg-mine-gradient hover:bg-primary-gradient focus:bg-primary-gradient uppercase font-medium text-white text-sm rounded-full py-2'>0.5%</button>

                    <button className='hover:bg-primary-gradient focus:bg-primary-gradient uppercase font-medium text-white text-sm rounded-full py-2'>1.00%</button>

                    <button className='hover:bg-primary-gradient focus:bg-primary-gradient uppercase font-medium text-white text-sm rounded-full py-2'>5.00%</button>
                  </div>
                </div>
                <div className='mb-6 overflow-y-auto'>
                  <div className='flex justify-between items-center mb-4'>
                    <p className='text-sm'>Custom Percentage</p>
                  ...
                  <div className='relative'>
                    <input type='text' className='rounded-2xl outline-none focus:outline-none w-full p-2 bg-gray-800 border border-gray-600' placeholder='0' />

                    <p className='text-xs text-[#f1df38] uppercase font-medium mt-2 text-end'>
                      YOUR TRANSACTION MAYBE FRONTRUN
                    </p>
                  </div>
                </div>
                {/*body*/}
